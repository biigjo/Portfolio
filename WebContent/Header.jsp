	...
	$(function(){
		...
		$("#logoutBtn").click(function(){
			...
			$.ajax({
				...
				url: "LogOutServlet",
				success: function() {
					if(url == 'http://localhost:9092/daengforest/DaengController?command=MsgReceiveAction&mtype=Receive' || url == 'http://localhost:9092/daengforest/DaengController?command=MsgReceiveAction&mtype=Send') {
